...
var clutter = "";
document.querySelector("#page-two>h1").textContent.split(" ").forEach(function(dets){
    clutter += `<span> ${dets} </span>`

    document.querySelector("#page-two>h1").innerHTML = clutter;
})

gsap.to("#page-two>h1>span", {
    scrollTrigger:{
        trigger: `#page-two>h1>span`,
        start: `top 45%`,
        end: `bottom bottom`,
        scroller: `main`,
        scrub: 0.5,
...
function canvas(){
    const canvas = document.querySelector("#page-three>canvas");
...
var clutter = "";
document.querySelector("#page-four>h1").textContent.split(" ").forEach(function(dets){
    clutter += `<span> ${dets} </span>`

    document.querySelector("#page-four>h1").innerHTML = clutter;
})
gsap.to("#page-four>h1>span", {
    scrollTrigger:{
        trigger: `#page-four>h1>span`,
        start: `top 33%`,
        end: `bottom 80%`,
        scroller: `main`,
        scrub: 0.5,
...
function nextcanvas(){
    const canvas = document.querySelector("#page-five>canvas");
const context = canvas.getContext("2d");
...
var clutter = "";
document.querySelector("#page-six>h1").textContent.split(" ").forEach(function(dets){
    clutter += `<span> ${dets} </span>`

    document.querySelector("#page-six>h1").innerHTML = clutter;
})
gsap.to("#page-six>h1>span", {
    scrollTrigger:{
        trigger: `#page-six>h1>span`,
        start: `top 35%`,
        end: `bottom 80%`,
        scroller: `main`,
        scrub: 0.5,
...
function pagecanvas(){
    const canvas = document.querySelector("#page-seven>canvas");
const context = canvas.getContext("2d");
...
gsap.to("#page-seven-circle",{
    scrollTrigger:{
        trigger:`#page-seven-circle`,
        start: `top center`,
        end: `bottom top`,
        scroller:`main`,
        scrub:0.5,
...
gsap.to("#page-seven-inner-circle",{
    scrollTrigger:{
        trigger:`#page-seven-inner-circle`,
        start: `top center`,
        end: `bottom top`,
        scroller:`main`,
        scrub:0.5,
    ...
    scale:1,
    backgroundColor: `#0a3cce97`
})

gsap.from("#page-thirteen>h1",{
